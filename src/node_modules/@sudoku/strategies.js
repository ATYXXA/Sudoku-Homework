...
// function createSudokuStrategy() {
//     const strategy = writable((() => {
//         const storedStrategy = localStorage.getItem('strategy');
// 		if (STRATEGIES.hasOwnProperty(storedStrategy)) {
// 			return storedDifficulty;
// 		}

// 		return Object.keys(STRATEGIES)[0];
//     })());
...
//         set(newStrategy) {
//             if (STRATEGIES.hasOwnProperty(newStrategy)) {
...
//         createStrategy() {
//             const strategyName = strategy.get();
//             switch (strategyName) {
//                 case 'xwing':
//                     return new XWingStrategy();
//                 // 添加更多策略
...
// export const strategy = createSudokuStrategy();


// class SudokuStrategyFactory {
//     constructor() {
//         this.strategy = writable(this.getDefaultStrategy());
//     }


//     subscribe(subscriber) {
//         return this.strategy.subscribe(subscriber);
//     }
...
//             localStorage.setItem('strategy', strategyName);
//         } else {
...
//     get() {
//         let storedStrategy = localStorage.getItem('strategy');
...
// export const sudokuStrategyFactory = new SudokuStrategyFactory();
